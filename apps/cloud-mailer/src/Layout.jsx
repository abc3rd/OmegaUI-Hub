...
import { Mail, LayoutDashboard, Plus, Users } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
        ...
        <Sidebar className="border-r border-slate-200">
          <SidebarHeader className="border-b border-slate-200 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold text-slate-900 text-lg">BulkMailer</h2>
                <p className="text-xs text-slate-500">Email Campaign Manager</p>
              </div>
            </div>
          </SidebarHeader>
        ...
        <main className="flex-1 flex flex-col">
          <header className="bg-white/80 backdrop-blur-sm border-b border-slate-200 px-6 py-4 md:hidden sticky top-0 z-10">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-bold text-slate-900">BulkMailer</h1>
            </div>
          </header>
