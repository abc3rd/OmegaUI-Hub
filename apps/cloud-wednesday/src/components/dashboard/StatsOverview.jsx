...
import { Folder, CheckCircle2, Clock, TrendingUp, AlertOctagon } from "lucide-react";
...
export default function StatsOverview({ boards, items, isLoading }) {
  ...
  const stats = [
    ...
    ...(blockedItems > 0 || overdueItems > 0 ? [{
      title: overdueItems > 0 ? "Overdue Tasks" : "Blocked Tasks",
      value: overdueItems > 0 ? overdueItems : blockedItems,
      icon: AlertOctagon,
