              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    variant="outline"
                    size="sm"
                    className="h-8 px-3 text-xs border-[#E1E5F3] hover:border-emerald-500 hover:text-emerald-600 hover:bg-emerald-50"
                ...
                <TooltipContent>View progress overview</TooltipContent>
              </Tooltip>
