              ...
              <div className="flex flex-wrap gap-3 mt-6">
                ...
                >
                  <Link to={createPageUrl("Progress")}>
                    <Button variant="outline" className="border-2 border-[#E1E5F3] hover:border-emerald-500 hover:bg-emerald-50 rounded-xl h-10 px-5 font-medium transition-all duration-200">
